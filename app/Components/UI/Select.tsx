            ...
            classNames={
                variant === "price"
                    ? {
                          ...
                          mainWrapper: "w-fit",
                          trigger:
                              "shadow-none data-[hover=true]:bg-transparent  bg-transparent data-[hover=true]:transparent rounded-[10px] py-[8px] h-10 min-h-unit-10 pl-[20px] pr-[45px]",
                          value: "group-data-[has-value=true]:text-gray-2 text-[14px] w-fit font-semibold",
                          selectorIcon: "right-4 stroke-grey-2",
                          popoverContent: "bg-white text-black-2",
                          innerWrapper: "w-auto",
                      }
                    : {
                          base: "w-full",
                          mainWrapper: "w-full",
                          trigger:
                              "border border-gray-1 shadow-none data-[hover=true]:bg-transparent bg-transparent data-[hover=true]:transparent rounded-[10px] py-[8px] h-10 min-h-unit-10 px-[15px]",
