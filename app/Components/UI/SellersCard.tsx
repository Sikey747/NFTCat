...
const SellersCard = ({ srs, title, price, position }: SellersCardProps) => {
    return (
        <article className="max-w-[180px] min-w-[130px] relative min-h-[200px] p-[11px] bg-white dark:bg-black-3 rounded-[20px] border border-grey-1 dark:border-black-3">
            <div className="text-static-white absolute top-[11px] left-[11px] w-[33px] h-[33px] flex justify-center items-center bg-red-violet rounded-full ">
